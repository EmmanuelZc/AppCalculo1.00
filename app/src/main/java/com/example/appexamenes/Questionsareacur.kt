...
class Questionsareacur : AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<dataclassareacur>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questionsareacur) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes4.USER_NAME)
        mQuestionsList = Constantes4.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult4::class.java)
                            intent.putExtra(Constantes4.USER_NAME, mUsername)
                            intent.putExtra(Constantes4.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes4.TOTAL_QUESTIONS, mQuestionsList!!.size)
