...
class QuestionsVolSecT: AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<dataclassvolsect>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_vol_sec_t) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes6.USER_NAME)
        mQuestionsList = Constantes6.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult6::class.java)
                            intent.putExtra(Constantes6.USER_NAME, mUsername)
                            intent.putExtra(Constantes6.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes6.TOTAL_QUESTIONS, mQuestionsList!!.size)
