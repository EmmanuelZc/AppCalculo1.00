...
class QuestionsDefinida : AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<QuestionsIntDef>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_definida) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes2.USER_NAME)
        mQuestionsList = Constantes2.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult2::class.java)
                            intent.putExtra(Constantes2.USER_NAME, mUsername)
                            intent.putExtra(Constantes2.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes2.TOTAL_QUESTIONS, mQuestionsList!!.size)
