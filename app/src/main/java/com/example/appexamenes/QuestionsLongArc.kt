...
class QuestionsLongArc : AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<dataclasslongarc>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_long_arc) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes7.USER_NAME)
        mQuestionsList = Constantes7.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult7::class.java)
                            intent.putExtra(Constantes7.USER_NAME, mUsername)
                            intent.putExtra(Constantes7.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes7.TOTAL_QUESTIONS, mQuestionsList!!.size)
