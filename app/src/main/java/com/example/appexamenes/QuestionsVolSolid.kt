...
class QuestionsVolSolid : AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<dataclassvolsolid>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_vol_solid) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes5.USER_NAME)
        mQuestionsList = Constantes5.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult5::class.java)
                            intent.putExtra(Constantes5.USER_NAME, mUsername)
                            intent.putExtra(Constantes5.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes5.TOTAL_QUESTIONS, mQuestionsList!!.size)
