...
class QuestionsIntNumrica : AppCompatActivity(),View.OnClickListener {
    private var mCurrentPosition: Int = 1
    private var mQuestionsList: ArrayList<dataclassintnum>? = null
    private var mSelectedOptionPosition: Int = 0
    private var mCorrectAnswers: Int = 0
    private var mUsername: String? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_int_numrica) //DECLARACION DE VARIABLES DE RECURSOS
        ...
        mUsername = intent.getStringExtra(Constantes3.USER_NAME)
        mQuestionsList = Constantes3.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            val intent = Intent(this, ActivityResult3::class.java)
                            intent.putExtra(Constantes3.USER_NAME, mUsername)
                            intent.putExtra(Constantes3.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constantes3.TOTAL_QUESTIONS, mQuestionsList!!.size)
